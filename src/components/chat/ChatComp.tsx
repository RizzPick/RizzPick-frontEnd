...
function ChatComp({data}:Props) {
  ...
  return (
    <div className={`flex flex-row items-center px-2.5 border-b-[1px] border-s-1-gray-400 h-[122px] cursor-pointer relative ${chat?.chatRoomId === data.chatRoomId ? "bg-[#F8EBFF]":""}`} onClick={handleClick}>
