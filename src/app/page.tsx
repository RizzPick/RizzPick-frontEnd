...
export default function Home() {
    ...
    return (
        <div className={`w-full bg-custom-gradient h-[100vh] flex flex-col items-center overflow-hidden relative sm:py-4 ${loaded ? 'animate-fadeIn' : ''}`}>
            ...
            <div className="flex flex-col w-full mt-5">
                ...
                <div className="flex justify-end mb-5 sm:justify-center sm:w-[224px] sm:mx-auto sm:flex-col sm:mt-36 sm:gap-5">
                    <button onClick={() => router.push('/signin')} className="cursor-pointer bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-10 rounded-full sm:text-[32px] z-10">
                        시작하기
                    </button>
