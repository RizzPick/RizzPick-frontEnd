...
export default function Home() {
    ...
    return (
        <div
            className={`w-full bg-custom-gradient h-[100vh] flex flex-col items-center overflow-hidden relative ${
        ...
        >
            ...
            <div className="flex flex-col w-full mt-5">
                <div className="flex items-baseline justify-end sm:flex-col sm:items-center sm:py-20">
                    <h1
                        className={`text-white text-4xl sm:text-[28px] font-bold mt-5 mb-4 transform transition-transform duration-1000 ${
                            loaded ? 'translate-y-0' : '-translate-y-full'
                        }`}
                    >
                        나만의 데이트 아이디어,
